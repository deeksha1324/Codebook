    ...
    <main>
        <section className="flex flex-col justify-center px-2">
            <div className="flex flex-col items-center my-4">
                <p className="text-3xl text-gray-700 font-bold my-10 dark:text-white text-center">Not found!</p>
                <div className="max-w-xs">
                    <img className="rounded-full" src={logo} alt="CodeBook Page Not Found" />
                </div>
            </div>
